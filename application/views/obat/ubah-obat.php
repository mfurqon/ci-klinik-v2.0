...
<div class="container-fluid">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-9">
            <?= form_open_multipart('obat/ubahObat/' . $obat['id']); ?>
            ...
            <div class="card shadow mt-3">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="date" class="form-control" id="tanggal_kadaluwarsa" name="tanggal_kadaluwarsa" value="<?= $obat['tanggal_kadaluwarsa']; ?>">
                            <?= form_error('tanggal_kadaluwarsa', '<small class="text-danger pl-3">', '</small>'); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="row">
                                <div class="col-sm-3">
                                    <img src="<?= base_url('assets/img/upload-obat/') . $obat['gambar_obat']; ?>" alt="gambar obat" class="img-thumbnail">
                                </div>
