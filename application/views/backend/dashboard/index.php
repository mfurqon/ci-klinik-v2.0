            ...
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <i class="fas fa-fw fa-capsules fa-2x text-success"></i>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <i class="fas fa-fw fa-calendar-days fa-2x text-info"></i>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                Total Pemesanan Obat</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $total_pemesanan_obat; ?></div>
                        </div>
                        <div class="col-auto">
            ...
            <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                Total Keranjang Obat</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $total_keranjang_obat; ?></div>
                        </div>
                        <div class="col-auto">
                            <i class="fas fa-cart-shopping fa-2x text-warning"></i>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $total_jenis_obat; ?></div>
                        </div>
                        <div class="col-auto">
                            <i class="fas fa-fw fa-tablets fa-2x text-primary"></i>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                Total Spesialisasi Dokter</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $total_spesialisasi_dokter; ?></div>
                        </div>
                        <div class="col-auto">
                            <i class="fas fa-fw fa-stethoscope fa-2x text-success"></i>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body d-flex align-items-center">
                    <div class="col text-center">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-sm-7">
                                <p class="text-muted">Kelola data obat, data dokter, data user, data janji temu, data pemesanan obat Anda dengan mudah dan efisien.</p>
                            </div>
                        </div>
                    </div>
                </div>
