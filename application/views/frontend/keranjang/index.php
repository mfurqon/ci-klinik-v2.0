<div class="container p-5">
    <?php if (!empty($temp_pemesanan_obat)) : ?>
        <form action="<?= base_url('update-keranjang'); ?>" method="post">
            <div class="card shadow col-lg-11 p-5">
                <div class="row">
                        ...
                        <div class="row border-top">
                            <div class="row main align-items-center my-3">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="jumlah_obat[<?= $tpo['id']; ?>]" class="border p-1 text-center quantity-input" data-id="<?= $tpo['id']; ?>" value="<?= $tpo['jumlah_obat']; ?>" style="width: 40px; height: 40px;" readonly>
                    ...
                    <div class="row justify-content-between">
                        ...
                        <button type="submit" class="btn btn-info col-3 mt-4">
